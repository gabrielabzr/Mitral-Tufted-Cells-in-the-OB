...
params.tstop=1000
import Parallel_Odor.odorstim as odorstim
odorstim.Fmax['Mint'][37]=0.7
for i in range(0, 37)+range(38,127):
  odorstim.Fmax['Mint'][i] = 0
import Parallel_Odor.net_mitral_centric as nmc # nmc.dc sets up full model gids
...
def patstim(filename):
  ...
  print wanted
  # read the spiketimes
  from Parallel_Odor.binspikes import SpikesReader
