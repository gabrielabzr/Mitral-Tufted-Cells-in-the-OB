...
import Parallel_Odor.odors as odors
from Parallel_Odor.gidfunc import mgid2glom, ismitral, ismtufted
tufts_diverged = {}
  ...
  def ev(self, time):
    ...
    for gid, cell in model.mitrals.items():
      ...
      if gidfunc.ismitral(gid):
        g_e_baseline = Parallel_Odor.params.orn_g_mc_baseline
        std_e = Parallel_Odor.params.orn_g_mc_std
        g_e_max = Parallel_Odor.params.orn_g_mc_max
      else:
        g_e_baseline = Parallel_Odor.params.orn_g_mt_baseline
        std_e = Parallel_Odor.params.orn_g_mt_std
        g_e_max = Parallel_Odor.params.orn_g_mt_max
...
if __name__ == '__main__':
  ...
  import Parallel_Odor.common as common
  common.nmitral = 2
  common.ncell = 10
  import Parallel_Odor.determine_connections as determine_connections
  import Parallel_Odor.odors as odors
