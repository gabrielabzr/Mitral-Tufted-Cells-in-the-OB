...
from Parallel_Odor.weightsave import weight_reset as clean_weights, weight_file
...
#    weight_file(params.filename+('.%d'%isaved))   
    ...
    import Parallel_Odor.binsave as binsave
    binsave.save(Parallel_Odor.params.filename, spikevec, idvec)
...
if __name__ == '__main__':
  ...
  from Parallel_Odor.odors import odors
