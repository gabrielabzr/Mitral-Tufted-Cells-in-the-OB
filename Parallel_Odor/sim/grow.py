...
from Parallel_Odor.misc import Ellipsoid, versor, getP, centroid, convert_direction, Spherical

from Parallel_Odor.params import ranstream, stream_soma, stream_dend, stream_apic, stream_tuft
from Parallel_Odor.params import glomRealCoords as glomCoord, bulbCenter, bulbAxis, GLOM_RADIUS
from Parallel_Odor.misc import distance
...
def gen_soma_pos(cfg, rng_sm, glompos, gid):
  ...
  if ismitral(gid):
    import Parallel_Odor.mcgrow as mcgrow
    ncell_per_glom = params.Nmitral_per_glom
  else:
    import Parallel_Odor.mtgrow as mtgrow
