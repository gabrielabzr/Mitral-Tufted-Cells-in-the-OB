...
def query(gid, verbrec=False):
    from Parallel_Odor.params import Nmitral as nmitral, gid_granule_begin
    from Parallel_Odor.granules import Ngranule
...
def mknetwork(gloms=[]):
    ...
    from Parallel_Odor.common import rank, nhost
