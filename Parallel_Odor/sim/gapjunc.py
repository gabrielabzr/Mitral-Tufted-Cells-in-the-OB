...
import Parallel_Odor.params as params; nmxg = params.Nmitral_per_glom; nmt = params.Nmtufted_per_glom; nmi = params.gid_mtufted_begin
from Parallel_Odor.common import pc, getmodel, nhost
import Parallel_Odor.util as util
import Parallel_Odor.sim.all2all as a2a
h.load_file('gj_nrn.hoc')
from Parallel_Odor.gidfunc import ismitral, ismtufted, mgid2glom
